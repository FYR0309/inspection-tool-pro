...
import { DOUBAO_API_URL, DOUBAO_API_KEY, DOUBAO_MODEL, IMAGE_EDIT_MODEL, IMAGE_API_KEY } from './config.js?v=20260711i';
import { compressImage } from './utils.js?v=20260711i';
...
function compressImageBrowser(dataUrl, maxPx = 1024, maxKB = 500) {
  return compressImage(dataUrl, { maxPx, maxKB, quality: 0.85 });
}
